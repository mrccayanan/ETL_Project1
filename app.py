...
<div class="dropdown">
    ...
    <p>Traffic Monster Members:</p>
        ...
        <li>Mical</li>
         ...
         <h2><em>Project Proposal & Conclusion: San Francisco Ranks as one of the Top Cities in the world for having the worst Traffic Congestion. Can we show that Rideshare &/or Construction can have a correlation to the increase of Traffic Congestion in San Francisco?</em></h2>
